          ...
          {props => (
            <Form className='flex flex-col gap-4 w-full'>
              <div className='relative group'>
                ...
                <Field className='w-full text-darkGray border rounded-md h-[50px] px-4 border-darkGray focus:border-[2px] focus:outline-none focus:ring-0 focus:border-primary' type="text" autoComplete="off" id="name" name="name" />
              ...
              <div>
                ...
                <div className='relative group'>
                  ...
                  <Field className='w-full  border rounded-md h-[50px] text-darkGray border-darkGray px-4 focus:border-[2px] focus:border-primary focus:ring-0 focus:outline-none' type={showPassword ? "text" : "password"} autoComplete="off" id="password" name="password" />
